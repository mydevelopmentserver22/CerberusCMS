...
/*
 ============================================================================================================
 +
 + IF: Internal Application :: Terminal
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + IF: Internal Application :: Generate
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + IF: Internal Application :: Genrate :: Directory Structure :: Default
 +
 ============================================================================================================
*/
...
echo ("
											Generate the Organized Directory Structure for this Software Project with Specified Directory Read and Write Permissions.<BR>
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/Extras/Builder");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/Extras/Builder/Hephaestus");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/Image/ScreenShots");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/Image/ScreenShots/Project ScreenShots");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Administration/Logging");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Administration/Logging/Activity_Logging");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Administration/System_Archive");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Pages");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/HTML5");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/HTML5/Canvas");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Nintendo");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Nintendo/NES");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Nintendo/SNES");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Nintendo/N64");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Sega");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Sega/GameGear");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Applications/Video_Games/ROM/Sega/Genesis");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Architect/Log");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Archive");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Live");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Music");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Push-To-Talk");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Recordings");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Audio/Streams");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Electronic_Mail");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/GPS");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/GPS/Coordinates");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/GLO");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Region");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Messenger");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Messenger/Clear-Text");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Document/Messenger/Encrypted");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Image/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Image/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Image/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Image/Profile");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Image/Profile/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Image/Streams");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Live");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Movies");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Profile");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Profile/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Files/Video/Streams");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files");

mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Archive");

mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Live");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Music");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Push-To-Talk");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Recordings");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Audio/Streams");

mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Activity_Logging");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Electronic_Mail");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Friends");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/GPS");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/GPS/Coordinates");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/GLO");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Region");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Messenger");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Messenger/Clear-Text");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Messenger/Encrypted");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Streams");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Document/Streams/Wall");

mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image/Profile");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image/Profile/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Image/Streams");
	

mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Gallery");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Gallery/Variable");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Gallery/Variable/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Live");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Movies");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Profile");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Profile/Backup");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Member/Setup/Indexes/Files/Video/Streams");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Camera");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Camera/Default");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Microphone");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Microphone/Default");
	
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Notifications");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Notifications/Default");
	
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Safe-HTML");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Text-Editor");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Time");
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Plug-Ins/Time/Default");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Integrity");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/System/Services");
...
mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Temporary/Messenger/Setup/Files/Video");
...
echo ("* Making: ./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Theme/<BR>");

mkdir("./$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_ROOT/$_Builder_Generate_POST_DIRECTORY_STRUCTURE_DIRECTORY_NAME_OPERATION/Theme");
...
$_Application_Module_Services_Kernel_FIND_KERNEL_FILE_LATEST								= "./Cerberus.zip";
...
curl_setopt($_Application_Module_Services_Kernel_cURL_Initialize_Latest, CURLOPT_URL, "https://github.com/DebianCMS/CerberusCMS_Archive/raw/main/Projects/Software Projects/CerberusCMS/Archive/PHP 7/PHP 7.4/TAR/Source/[12-06-2023] CerberusCMS - Version Number - 4 - Build Number - 0.8 - Nyx - Edit Number - 4325 - Manual Edit Number - 0233 - 01.tar.gz");
curl_setopt($_Application_Module_Services_Kernel_cURL_Initialize_Latest, CURLOPT_SSL_VERIFYPEER, false);
...
echo ("
				<B>This Application Builds This Software Project From Scratch</B><BR>
				This Application will build this Software Project from Scratch-Copy. This is useful for creating an entirely fresh and free of any Malware installation of this Software Project by making it impossible for any possibly malicious code injected files to be carried over from machine to machine.<BR><BR>
				...
				the Secure Socket Layer Libraries / Open Source Secure Socket Layer Application / Transport Layer Security Application on the Personal-Computer or on the Web Server to a malicious version as well as by updating the other Applications on the Web Server itself to a backdoored version and or a malicious version of that Application where the malicious attacker / malicious hacker can then compromise all of the encryption on the Web Server to steal credit card numbers and other data before that data is encrypted through the REQUEST, POST or GET encryption programming code passed through the Secure Socket Layer or Transport Layer Security Applications installed on the Personal-Computer or Web Server Operating System.<BR><BR>
				...
				undetectable to Malware Scanners. This Application will build this Software Project from Scratch-Copy. Scratch-Copy means that the entire system of this specific instance of this Software Project will be built from Scratch and then from Scratch-Copy of the actual Programming Source Code and not by copying the files from the Master GIT Repository or from anywhere else.<BR><BR>
				
				<B>How Does That Work, Exactly ?</B><BR>
				Installing in this method will make, build and create clean the free of any Malware:<BR>
				* All ~670+ Unique Directories From this Software Project to this Web Server by first creating the Organized Directory Structure from scratch with this Application.<BR>
				* All ~2,300+ Unique Files From this Software Project with File Extensions will be made from scratch on this Web Server with this Application.<BR>
				* All ~2,300+ Unique Files From this Software Project will be opened by this Application and all ~250,000+ Lines of Clean and Documented Pre-Hyper-Text-Post-Processor Programming Code from that will be copied from the Master GIT Repository for this Software Project and then this Programming Source Code will be pasted into each individual file on this Web Server with this Application.<BR>
